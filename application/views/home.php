                    ...
                    <div class="input-group">
                      ...
                      ?>
                        <div class="row">
                          ...
                          <button class="btn btn-outline-secondary text-light col-3" type="button" onclick="javascript: min('input<?php echo $prd->id_produk; ?>');">-</button>
                          <input type="number" min="1" name="qty" value=1 id="input<?php echo $prd->id_produk; ?>" class="form-control col-6 text-center">
                          <button class="btn  btn-outline-secondary text-light col-3 " type="button" onclick="javascript: plus('input<?php echo $prd->id_produk; ?>',<?php echo $prd->stok; ?>);">+</button>
